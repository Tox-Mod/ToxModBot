...
## Welcome to the {{botName}} Website/Dashborad

These terms and conditions outline the rules and regulations for the use of `{{botName}}`s Dashboard, Website and API.

By accessing this website we assume you accept these terms and conditions in full. 
Do not continue to use the `toxmod.xyz` Website if you do not accept all of the terms and conditions stated on this page.
...
We employ the use of cookies. By using this website you consent to the use of cookies in accordance with {{botName}}’s privacy policy.

Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliates / advertising partners may also use cookies.

## License

Unless otherwise stated, {{botName}} and/or it’s licensors own the intellectual property rights for all material on this Website. 
...
4.  Redistribute content from the {{botName}} Bot, Website, Dashboard or API (unless content is specifically made for redistribution).
...
No use of {{botName}}’s logo or other artwork will be allowed for linking absent a trademark license agreement.
...
## Contact Information
You may contact the {{botName}} Developer/Owner by E-Mail at: [toxic.dev09@gmail.com](mailto:toxic.dev09@gmail.com)